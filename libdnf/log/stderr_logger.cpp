...
void StderrLogger::initialize(LogLevel log_level)
{
    log4cxx::PatternLayoutPtr layout = new log4cxx::PatternLayout("[%-5p] %m\n");
...
void StderrLogger::set_log_level(LogLevel log_level)
{
    ...
    switch (log_level) {
        case LogLevel::OFF:
            ...
            break;
        case LogLevel::QUIET:
            pImpl->filter_ptr->setLevelMin(log4cxx::Level::getWarn());
            break;
