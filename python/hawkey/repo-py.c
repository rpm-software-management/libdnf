...
static PyGetSetDef repo_getsetters[] = {
    { (char *)"cost",
      (getter)get_int,
      (setter)set_int,
      (char *)"repository cost",
      (void *)&(IntGetSetter){ hy_repo_get_cost, hy_repo_set_cost } },
    { (char *)"name", (getter)get_str, (setter)set_str, NULL, (void *)HY_REPO_NAME },
    { (char *)"priority",
      (getter)get_int,
      (setter)set_int,
      (char *)"repository priority",
      (void *)&(IntGetSetter){ hy_repo_get_priority, hy_repo_set_priority } },
    { (char *)"repomd_fn", (getter)get_str, (setter)set_str, NULL, (void *)HY_REPO_MD_FN },
    { (char *)"primary_fn", (getter)get_str, (setter)set_str, NULL, (void *)HY_REPO_PRIMARY_FN },
    { (char *)"filelists_fn",
      (getter)get_str,
      (setter)set_str,
      NULL,
      (void *)HY_REPO_FILELISTS_FN },
    { (char *)"presto_fn", (getter)get_str, (setter)set_str, NULL, (void *)HY_REPO_PRESTO_FN },
    { (char *)"updateinfo_fn",
      (getter)get_str,
      (setter)set_str,
      NULL,
...
PyTypeObject repo_Type = {
    PyVarObject_HEAD_INIT(NULL, 0) "_hawkey.Repo", /*tp_name*/
