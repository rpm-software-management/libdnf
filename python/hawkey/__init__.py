...
SOLUTION_ALLOW_INSTALL = _hawkey.HY_ALLOW_INSTALL
SOLUTION_ALLOW_REINSTALL = _hawkey.HY_ALLOW_REINSTALL
SOLUTION_ALLOW_UPGRADE = _hawkey.HY_ALLOW_UPGRADE
SOLUTION_ALLOW_DOWNGRADE = _hawkey.HY_ALLOW_DOWNGRADE
SOLUTION_ALLOW_CHANGE = _hawkey.HY_ALLOW_CHANGE
SOLUTION_ALLOW_OBSOLETE = _hawkey.HY_ALLOW_OBSOLETE
SOLUTION_ALLOW_REPLACEMENT = _hawkey.HY_ALLOW_REPLACEMENT
SOLUTION_ALLOW_REMOVE = _hawkey.HY_ALLOW_REMOVE
SOLUTION_DO_NOT_INSTALL = _hawkey.HY_DO_NOT_INSTALL
SOLUTION_DO_NOT_REMOVE = _hawkey.HY_DO_NOT_REMOVE
SOLUTION_DO_NOT_OBSOLETE = _hawkey.HY_DO_NOT_OBSOLETE
SOLUTION_DO_NOT_UPGRADE = _hawkey.HY_DO_NOT_UPGRADE
SOLUTION_BAD_SOLUTION = _hawkey.HY_BAD_SOLUTION
