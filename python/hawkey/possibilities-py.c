...
typedef struct
{
    PyObject_HEAD HyPossibilities possibilities;
    PyObject *sack;
...
static PyObject *
possibilities_iter(PyObject *self)
{
    Py_INCREF(self);
    return self;
}
...
static PyObject *
possibilities_next(_PossibilitiesObject *self)
{
...
PyTypeObject possibilities_Type = {
    PyVarObject_HEAD_INIT(NULL, 0) "_hawkey.Possibilities", /*tp_name*/
