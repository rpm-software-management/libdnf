...
typedef struct
{
    PyObject_HEAD DnfAdvisoryRef *advisoryref;
    PyObject *sack;
} _AdvisoryRefObject;
...
advisoryref_richcompare(PyObject *self, PyObject *other, int op)
{
    ...
    if (!advisoryref_converter(self, &cself) || !advisoryref_converter(other, &cother)) {
...
PyTypeObject advisoryref_Type = {
    PyVarObject_HEAD_INIT(NULL, 0) "_hawkey.AdvisoryRef", /*tp_name*/
