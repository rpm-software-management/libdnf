...
void UtilsStringTest::test_rsplit() {
    CPPUNIT_ASSERT_EQUAL(std::vector<std::string>({""}), rsplit("", "; ", 100));
    CPPUNIT_ASSERT_EQUAL(std::vector<std::string>({"aa"}), rsplit("aa", "; ", 100));
    CPPUNIT_ASSERT_EQUAL(std::vector<std::string>({"aa", "bb"}), rsplit("aa; bb", "; ", 100));
