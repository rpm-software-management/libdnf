...
#ifndef LIBDNF_RPM_REPO_CONFIG_REPO_HPP
#define LIBDNF_RPM_REPO_CONFIG_REPO_HPP
...
constexpr int32_t DEFAULT_REPO_PRIORITY = 99;
constexpr int32_t DEFAULT_REPO_COST = 1000;
...
public:
    ...
    ~ConfigRepo();
    ConfigRepo(ConfigRepo && src) noexcept;
