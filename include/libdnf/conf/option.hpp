...
public:
    ...
    /// Exception that is generated when an invalid input value is detected.
    class ModifyLocked : public LogicError {
    public:
        using LogicError::LogicError;
        const char * get_domain_name() const noexcept override { return "libdnf::Option"; }
        const char * get_name() const noexcept override { return "ModifyLocked"; }
        const char * get_description() const noexcept override { return "Attempt to modify locked option"; }
    };
